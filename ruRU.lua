...
L["noTimer"] = "Нет таймера"; --No timer
L["noCurrentTimer"] = "Нет текущего таймера"; --No current timer
L["noActiveTimers"] = "Нет активных таймеров"; --No active timers
L["second"] = "секунда"; --Second (singular).
L["seconds"] = "секунды"; --Seconds (plural).
L["minute"] = "минута"; --Minute (singular).
L["minutes"] = "минуты"; --Minutes (plural).
L["hour"] = "час"; --Hour (singular).
L["hours"] = "часы"; --Hours (plural).
L["day"] = "день"; --Day (singular).
L["days"] = "дни"; --Days (plural).
L["year"] = "год"; --Year (singular).
L["years"] = "годы"; --Years (plural).
L["secondMedium"] = "сек"; --Second (singular).
L["secondsMedium"] = "сек"; --Seconds (plural).
L["minuteMedium"] = "мин"; --Minute (singular).
L["minutesMedium"] = "мин"; --Minutes (plural).
L["hourMedium"] = "час"; --Hour (singular).
L["hoursMedium"] = "часы"; --Hours (plural).
L["dayMedium"] = "день"; --Day (singular).
L["daysMedium"] = "дни"; --Days (plural).
L["yearMedium"] = "год"; --Year (singular).
L["yearsMedium"] = "годы"; --Years (plural).
...
L["yearShort"] = "г"; --Used in short timers like 1d8h (single letter only, usually the first letter of years).
L["startsIn"] = "Начинается через %s"; --"Starts in 1hour".
L["endsIn"] = "Заканчивается через %s"; --"Ends in 1hour".
L["versionOutOfDate"] = "Nova Instance Tracker устарел, пожалуйста, обновите на https://www.curseforge.com/wow/addons/nova-instance-tracker";
L["Options"] = "Настройки";
L["Reset Data"] = "Сброс данных"; --A button to Reset data.

L["Error"] = "Ошибка";
L["delete"] = "Удалить";
L["confirmInstanceDeletion"] = "Подтвердить удаление подземелья";
L["confirmCharacterDeletion"] = "Подтвердить удаление персонажа";
